          ...
          <div class="a-container-content-one">
            ...
            <div class="acco-sideline">
              ...
              <div class="acco-sideline-content-there">
                <a-row>
                  <a-col :span="12">
                    <a-checkbox v-model:checked="apHexiaoAuto" :disabled="isEdit">
                      应付审核自动核销
                    </a-checkbox>
                  </a-col>
                  <a-col :span="12">
                    <a-checkbox v-model:checked="apFukuanHxwc" :disabled="isEdit">
                      月末处理必须完成付款核销
                    </a-checkbox>
                  </a-col>
                  <br/><br/>
                  <a-col :span="12">
                    <a-checkbox v-model:checked="apCheckFlag" :disabled="isEdit">
                      应付单据必须复核后生效
                    </a-checkbox>
                  </a-col>
                </a-row>
            ...
            <div class="acco-sideline">
              <span>应付来源</span>
              <div class="acco-sideline-content-there">
                <a-radio-group v-model:value="apSourceFlag" :disabled="isEdit || sourceTypeNum>0" style="width:100%;">
                  <a-row>
                    <a-col :span="12">
            ...
            <div class="acco-sideline">
              ...
              <div class="acco-sideline-content-there">
                <a-row>
                  <a-col :span="12">
                    <a-checkbox v-model:checked="apYfdXinyong" :disabled="isEdit">
                      应付单控制供应商信用
                    </a-checkbox>
                  </a-col>
                  <a-col :span="12">
                    <a-checkbox v-model:checked="apTkdXinyong" :disabled="isEdit">
                      退款单控制供应商信用
                    </a-checkbox>
                  </a-col>
                </a-row>
            ...
            <div class="acco-sideline">
              ...
              <div class="acco-sideline-content-there">
                <a-row>
                  <a-col :span="12">
                    <a-checkbox v-model:checked="apPingzhengAuto" :disabled="isEdit">
                      单据审核后立即生成凭证
                    </a-checkbox>
                  </a-col>
                  <a-col :span="12">
                    <a-checkbox v-model:checked="apPingzhengAll" :disabled="isEdit">
                      结账前业务单据必须全部生成凭证
                    </a-checkbox>
                  </a-col>
                </a-row>
...
const apHexiaoAuto:any = ref(false)
const apFukuanHxwc:any = ref(false)
const apYfdXinyong:any = ref(false)
const apTkdXinyong:any = ref(false)
const apPingzhengAuto:any = ref(false)
const apPingzhengAll:any = ref(false)
const apCheckFlag:any = ref(false)
const apSourceFlag:any = ref('0')

const handleBus = async (bus) => {
  if (bus == '0') {
    isEdit.value = false
  } else if (bus == '1') { //恢复系统
    apHexiaoAuto.value = false
    apFukuanHxwc.value = false
    apYfdXinyong.value = false
    apTkdXinyong.value = false
    apPingzhengAuto.value = false
    apPingzhengAll.value = false
    apCheckFlag.value = false
    apSourceFlag.value = (formItems.value.apSourceFlag == '1'?'1':'0')
  } else if (bus == '2') {
    isEdit.value = true
    formItems.value.apHexiaoAuto = (apHexiaoAuto.value==true?'1':'0')
    formItems.value.apFukuanHxwc = (apFukuanHxwc.value==true?'1':'0')
    formItems.value.apYfdXinyong = (apYfdXinyong.value==true?'1':'0')
    formItems.value.apTkdXinyong = (apTkdXinyong.value==true?'1':'0')
    formItems.value.apPingzhengAuto = (apPingzhengAuto.value==true?'1':'0')
    formItems.value.apPingzhengAll = (apPingzhengAll.value==true?'1':'0')
    formItems.value.apCheckFlag = (apCheckFlag.value==true?'1':'0')
    formItems.value.apSourceFlag = apSourceFlag.value
    await saveStocckAccount(formItems.value)
  } else { // 放弃修改
    apHexiaoAuto.value = (formItems.value.apHexiaoAuto=='1')
    apFukuanHxwc.value = (formItems.value.apFukuanHxwc=='1')
    apYfdXinyong.value = (formItems.value.apYfdXinyong=='1')
    apTkdXinyong.value = (formItems.value.apTkdXinyong=='1')
    apPingzhengAuto.value = (formItems.value.apPingzhengAuto=='1')
    apPingzhengAll.value = (formItems.value.apPingzhengAll=='1')
    apCheckFlag.value = (formItems.value.apCheckFlag=='1')
    apSourceFlag.value = (formItems.value.apSourceFlag == '1'?'1':'0')
    isEdit.value = true
  }
}
...
const dynamicAdReload = async (obj) => {
  ...
  const hexiao = await useRouteApi(findWriteOffByIyearAndBillStyle,{schemaName: database})({iyear: databaseYear.value,billStyle: 'FKD'})
  const hzhcds = await useRouteApi(findHzhcdsByIyearAndBillStyle,{schemaName: database})({iyear:databaseYear.value,billStyle: 'YFD'})
