    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;调拨出入库单列表</span>
        </div>
            ...
            <div class="border-div">
              ...
              <div style="text-align: center">
                ...
                <a-select
                  ...
                  show-search
                  style="width: 60%;text-align: center;margin-left: 15px;"
                >
                  <a-select-option
...
//************************************* 查询条件 ***************************
const dataType: any = ref('DBRKD')
const dataTypeList: any = ref([{title:'调拨入库',value:'DBRKD'},{title:'调拨出库',value:'DBCKD'}])
const sup: any = ref('')
