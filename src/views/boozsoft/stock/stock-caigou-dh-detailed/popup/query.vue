  ...
  >
    <template #title>
      <div style="height: 30px;width: 100%;background-color: #5f375c;color: white;line-height: 30px;text-align: left;">
        ...
        <span style="font-size: 14px">账表管理</span>
      </div>
    </template>
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;采购到货单执行表</span>
        </div>
        <div class="nc-open-content">
          <div class="open-content-up">
            ...
            <div class="border-div">
              ...
              <div>
                ...
                <a-select
                  ...
                  show-search
                  style="width: 192px;margin-left: 40px;"
                >
                  <a-select-option
            ...
            <div style="margin: 10px;">
              <a-checkbox v-model:checked="inQCDHD">包含期初采购到货单</a-checkbox>
            </div>
          </div>
        </div>
      </div>
...
function handleOk() {
  ...
  let log:any=['会计期间:【'+strTime+','+endTime+'】','单据编码:【'+strNum.value+','+endNum.value+'】','业务类型:【'+dataTypeName+'】','供应商:【'+supName+'】','结算供应商:【'+jssupName+'】','存货:【'+stockName+'】','包含期初到货单:【'+inQCDHD.value+'】']

  let map={
    strDateView:radiovalue.value=='1'?strDate.value:timeformat(strDate2.value),
    endDateView:radiovalue.value=='1'?endDate.value:timeformat(endDate2.value),
    strDate:strTime,
    endDate:endTime,
    ...
    jssup:jssup.value,
    cinvode:stock.value,
    cwhcode:cangku.value,
    billStyle:'CGDHD',
    inQCDHD:inQCDHD.value,
