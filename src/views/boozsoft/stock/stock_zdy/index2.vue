...
<script setup lang="ts">
  ...
  } from '/@/api/record/stock/stock-define-head';
  import { stockDefineBodyDelByHeadId } from '/@/api/record/stock/stock-define-body';
  import {
    countBodyByHeadIdAndDeName,
    stockDefineBodyDelById,
    stockDefineBodyFindByAll,
    stockDefineBodySave,
  } from '/@/api/record/stock/stock-define-body';
  ...
  function exportExcel() {
    ...
    aoaToSheetXlsx({
      data: dataArr,
      header: a,
      filename: databaseName.value+'-存货档案自定义项.xlsx',
    });
  }
