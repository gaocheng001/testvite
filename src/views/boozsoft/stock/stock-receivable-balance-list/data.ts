...
/*    {
    ...
    },
    {
      ...
      align: 'right',
      ellipsis: true,
      slots: {customRender: 'initialBalance'}
    },
    {
      title: '应收金额',
      ...
      align: 'right',
      ellipsis: true,
      slots: {customRender: 'amountReceivable'}
    },
    {
      title: '已收金额',
      ...
      align: 'right',
      ellipsis: true,
      slots: {customRender: 'amountReceived'}
    },
    {
      title: '期末金额',
      ...
      align: 'right',
      ellipsis: true,
      slots: {customRender: 'closingAmount'}
    },
    {
      title: '收款比例',
      ...
      align: 'right',
      ellipsis: true,
      slots: {customRender: 'receiptRatio'}
    }
    ],
}
