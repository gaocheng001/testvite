  ...
  >
    <template #title>
      <div style="height: 30px;width: 100%;background-color: #5f375c;color: white;line-height: 30px;">
        ...
        <span style="font-size: 13px">盘点管理</span>
      </div>
    </template>
          ...
          <div class="open-content-up">
            ...
            <div class="border-div">
              ...
              <div style="margin-left: 14px;">
                ...
                <p/>
                <label style="font-weight: bold;color: #5a5a5a;">标题显示：</label>
                &nbsp;
                <a-select
                  v-model:value="formItems.printFlg"
                  show-search
                  style="width: 277px;text-align: center;"
                >
                  <a-select-option value="2" >不包含盘点数据</a-select-option>
                  <a-select-option value="1" >包含盘点数据</a-select-option>
                  <template #suffixIcon><CaretDownOutlined style="color:#666666;"/></template>
                </a-select>
              </div>
            </div>
            <div class="border-div">
              ...
              <div style="margin-left: 14px;">
                <a-checkbox v-model:checked="formItems.printUser" style="width: 130px"> 打印制单人 </a-checkbox>
<!--
...
import {AppstoreOutlined, PrinterOutlined,CaretDownOutlined,EditOutlined} from '@ant-design/icons-vue'
