    ...
    <div class="import-centent-div" >
      <div class="import-info-div">
        <div class="import-div-top">
          ...
          <div>
            <span>导入内容：</span><span style="font-weight: bold;font-size: 20px;">采购价格表</span><br/><br/>
            <span>模板样式：</span>
            <Select
...
const tablelist:any = ref(['存货编码','存货名称','规格型号','主计量','普通采购价','零售价','最低价','最高价','一级采购价','二级采购价','三级采购价','四级采购价','五级采购价','六级采购价','七级采购价','八级采购价','主计量'])
...
function loadDataSuccess(excelDataList) {
  ...
  if (items.length>0) {
    for (let i = 0; i < items.length; i++) {
      ...
      item1.invscost1 = item['一级采购价']
      item1.invscost2 = item['二级采购价']
      item1.invscost3 = item['三级采购价']
      item1.invscost4 = item['四级采购价']
      item1.invscost5 = item['五级采购价']
      item1.invscost6 = item['六级采购价']
      item1.invscost7 = item['七级采购价']
      item1.invscost8 = item['八级采购价']
