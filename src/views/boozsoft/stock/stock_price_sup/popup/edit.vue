    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;采购价格表</span>
        </div>
        <div class="nc-open-content" style="padding-top: 15px;">
...
import {findListByTypeAndId} from "/@/api/record/stock/stock-price";
