    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;存货采购排行榜</span>
        </div>
        <div
...
<!--                  <a-select-option value="3" >三等分</a-select-option>-->
            ...
            <div class="border-div">
              ...
              <div style="margin-left: 14px;">
                ...
                <a-checkbox v-model:checked="formItems.thisDate" style="width: 130px"> 打印当前时间 </a-checkbox>
              </div>
            </div>
          </div>
        </div>
