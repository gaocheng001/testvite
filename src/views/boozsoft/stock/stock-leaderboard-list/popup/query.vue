...
<!--      <div style="display: flex;" class="vben-basic-title">
    ...
    <div class="nc-open-content" style="height: 100%">
      <div style="display: block;text-align: center;">
        ...
        <span style="font-size: 30px;color: #0096c7;font-weight: bold;">&ensp;销售排行榜</span>
      </div>
      <div class="open-content-up">
        ...
        <Tabs type="card" v-model:activeKey="defaultTabsKey" tabPosition="left" style="width: 20%;float: left;">
          <TabPane key="1" tab="存货销售排行榜"></TabPane>
          <TabPane key="2" tab="客户销售排行榜"></TabPane>
<!--          <TabPane key="3" tab="业务员销售排行榜"></TabPane>
          <TabPane key="4" tab="地区销售排行榜"></TabPane>-->
        </Tabs>
