...
import {
  findBySyDataMainSourrceMap, findQTRKD_OnlyByXyData
...
async function findAllXySource() {
  ...
  pageParameter.ccode = xyccode.value
  let list = await useRouteApi(findQTRKD_OnlyByXyData, {schemaName: schemaName})(pageParameter)
  let tableLength = 0
