    ...
    <div style="display: inline-flex;justify-content: space-between;width: 100%;">
      <div style="width: calc(100% - 150px);height: 100%;">
        <div style="text-align: center;padding: 10px 0 5px;">
          ...
          <span style="line-height:30px;font-size: 24px;color: #0096c7;font-weight: bold;">&ensp;数量收发存汇总表</span>
        </div>
        <div
              ...
              <div style="margin-left: 14px;">
                <ul>
                  <li style="margin: 2% 0px;">
                    ...
                    <a-date-picker :allowClear="false" placeholder="" style="width: 320px;margin-left: 25px;text-align: center;" v-model:value="strDate" @change="verifyDate"/>
                  </li>
                  <li style="margin: 2% 0px;">
...
function handleOk() {
  let map={
    ...
    strDate:hasBlank(strDate.value)?'':transformTimestamp(strDate.value),
