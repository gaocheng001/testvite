...
const columnPropertyModel = {
  '1': [
    ...
    {
      title: '存货分类',
      dataIndex: 'cinvodeClass',
      ellipsis: true,
      slots: {customRender: 'cinvodeClass'}
    },
    {
      title: '条形码',
...

    {
      ...
      dataIndex: 'pending1',
      ellipsis: true,
      slots: {customRender: 'pending1'},
    },
    {
      title: '已记账成本',
      dataIndex: 'pending2',
      ellipsis: true,
      slots: {customRender: 'pending2'}
    },
    {
      title: '未记账成本',
      dataIndex: 'pending3',
      ellipsis: true,
      slots: {customRender: 'pending3'}
    },
    {
      title: '总成本',
      dataIndex: 'pending4',
      ellipsis: true,
      slots: {customRender: 'pending4'}
    },
    {
      title: '分摊费用',
      dataIndex: 'pending5',
      ellipsis: true,
      slots: {customRender: 'pending5'}
    },
    {
      title: '毛利',
      dataIndex: 'pending6',
      ellipsis: true,
      slots: {customRender: 'pending6'}
    },
    {
      title: '毛利率',
      dataIndex: 'pending7',
      ellipsis: true,
      slots: {customRender: 'pending7'},
    },
