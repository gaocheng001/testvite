  ...
  >
    ...
    >
      <div class="open-content-up" style="text-align: center;margin-top: 30px;">
        <label style="margin-left: 40px;">应收类型：</label>
        <a-select allowClear style="width: 200px;" v-model:value="formItems.arStyle" @change="arStyleChange">
          ...
          <a-select-option value="YSK">应收款</a-select-option>
          <a-select-option value="YUSK">预收款</a-select-option>
          <a-select-option value="YSPJ">应收票据</a-select-option>
        ...
        <br>
        <label style="margin-left: 40px;">收款方向：</label>
        ...
        <br>
        <label style="margin-left: 40px;">预收账款：</label>
        ...
        <br>
        <label style="margin-left: 40px;">应收账款：</label>
...
import {getStockArBalanceMaxIineId, stockArBalanceSave} from "/@/api/record/stock/stock_ar_balance";
...
const [registerSelectProjectPage, { openModal: openSelectProjectPage }] = useModal()
  ...
  const [register, { closeModal }] = useModalInner( async (data) => {
    ...
    formItems.value={}
    formItems.value.custId=data.custDataChange.key
    formItems.value.arCustName=data.custDataChange.custName
  ...
  async function handleOk() {
    ...
    let map={
      ...
      bcheck:'0',
      lineId:await useRouteApi(getStockArBalanceMaxIineId, { schemaName: database })(iyear.value)
    }
...
function arStyleChange() {
  ...
  if(formItems.value.arStyle=='YUSK'){
    ...
    arDirList.value.push({title:'预收',value:'1'})
    ...
    arDirList.value.push({title:'应收',value:'0'})
