...
<!--   <div><textarea>供应商应付余额表的页面</textarea>复制内容快速定位页面</div>-->
    <div class="app-container-top">
      ...
      <div class="app-container-head">
        ...
        <div class="container-head-title" style="padding-left: 35%;text-align: center;margin-top: 20px;">
          <b class="noneSpan" style="font-size: 26px;">供应商应付余额表</b>
  ...
  useNewPrint({data: ['l', 'px', 'a4', true]}, (doc) => {
    ...
    doc.autoTable({
      head: [['供应商应付余额表','', '', '',  '', ''],
        ...
        ['结算供应商编码', '结算供应商名称', '期初余额', '应付金额', '付款金额', '期末余额']
      ],
      body: printList,
      // startY: 60,
      styles: tableStyle(),
...
const excelData = () => {
  ...
  const sheet:any = [
    {
      ...
      multiHeader: [
        ['单位：'+pageParameter.companyName, '', '期间：'+qijian.value, '', '', ''],
        ['结算供应商编码', '结算供应商名称', '期初余额', '应付金额', '收款金额', '期末余额']
      ],
      table: arrData,
  ...
  const bookType = 'xlsx'
  // 类型默认为xlsx
  writeExcel(wb, bookType, '供应商应付余额表_'+pageParameter.companyName)
}
