  ...
  <BasicModal width="700px"
    ...
    <template #title>
      <div style="display: flex;margin-left: 10px;margin-top: 5px;" class="vben-basic-title">
        ...
        <span style="line-height: 29px;font-size: 20px;margin-left: 10px;color: rgb(21, 142, 184)">采购发票来源单据</span>
      </div>
    </template>
      ...
      <div class="content-body" style="margin-top: 5px;">
        ...
        >
          <template #xyBillStyle="{ record }">
            {{ record.xyBillStyle=='CGRKD'?'采购入库单':record.xyBillStyle=='CGDHD'?'采购到货单':record.xyBillStyle=='CGDD'?'采购订单':'' }}
          </template>
