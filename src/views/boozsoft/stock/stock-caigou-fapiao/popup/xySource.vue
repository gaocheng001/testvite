  ...
  <BasicModal width="700px"
    ...
    <template #title>
      <div style="display: flex;margin-left: 10px;margin-top: 5px;" class="vben-basic-title">
        ...
        <span style="line-height: 29px;font-size: 20px;margin-left: 10px;color: rgb(21, 142, 184)">采购发票下游单据</span>
      </div>
    </template>
      ...
      <div class="content-body" style="margin-top: 5px;">
        ...
        >
          <template #xyBillStyle="{ record }">
            {{ record.xyBillStyle=='CGRKD'?'采购入库单':record.xyBillStyle=='CGDHD'?'采购退货单':record.xyBillStyle=='CGJSD'?'采购结算单':'' }}
          </template>
