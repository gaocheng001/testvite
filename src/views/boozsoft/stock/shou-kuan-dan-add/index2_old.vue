<template>
  <div>
    <div class="app-container">
      <div class="app-container-top" style="padding:10px;">
      ...
      <div class="open-content-down" :style="{height: (windowHeight+70)+'px'}">
        <div class="acb-head">
          <div class="acbgead-one">
            ...
            <div class="acbgead-one-changes" style="border:1px;">
              <VerticalRightOutlined/>&nbsp;
              <LeftOutlined/>&nbsp;
              <RightOutlined/>&nbsp;
              <VerticalLeftOutlined/>
            </div>
            <span style="font-size: 24px;color: #0096c7;font-weight: bold;">收款单</span>
          </div>
        </div>
        ...
        >
          ...
          <template #summary>
            <TableSummaryRow style="background-color: #cccccc;">
              ...
              <!-- 数量 -->
              <TableSummaryCell :index="6" align="center"></TableSummaryCell>
              <!-- 原值 -->
              <TableSummaryCell :index="7" align="right"></TableSummaryCell>
              <!-- 进项税额 -->
              <TableSummaryCell :index="8" align="right"></TableSummaryCell>
              <!-- 累计折旧 -->
              <TableSummaryCell :index="9" align="right"></TableSummaryCell>
              <!-- 净值 -->
              <TableSummaryCell :index="10" align="right"></TableSummaryCell>
              <!-- 卡片日期 -->
...
.app-container,.app-container-top{
