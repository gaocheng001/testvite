  ...
  <BasicModal
    ...
    <div class="nc-open-content">
      ...
      <div class="cont-bottom">
        选择替换内容:&emsp;&emsp;
        <Select style="width: 50%" v-model:value="openParameter.type" @change="contentRuleChange">
        ...
        <Select style="width: 25%" v-model:value="openParameter.cdfineValue"
                :disabled="openParameter.type != 'cdfine'"
                @change="cdfineRuleChange"
                :options="fzItems.map(fz => ({ value: fz.key,label: fz.title }))"/>
        <br/>
        替换前内容:&emsp;&emsp;&emsp;<Input v-model:value="openParameter.before" v-if="isInput"
                                       placeholder="请输入内容"
                                       style="width: 76%"/>
        ...
        替换后内容:&emsp;&emsp;&emsp;<Input v-model:value="openParameter.after" v-if="isInput"
                                       placeholder="请输入内容"
                                       style="width: 76%"/>
