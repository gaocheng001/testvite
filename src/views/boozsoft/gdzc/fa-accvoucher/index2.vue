    ...
    <div class="app-container-top">
      <div class="app-container-top-one">
        ...
        <div class="act-one-d-title">
          <span class="acto-d-title-span">资产凭证列表</span>
        </div>
        <div class="act-one-d-btn-group">
          ...
          <Button class="actod-btn"
                  @click="pingzhengEditor.openPingZhengEditEditer(tableSelectedRowObjs)">修改
          </Button>
          ...
          <Popover placement="bottom">
            <template #content>
              ...
              <span class="group-btn-span-special"
                    @click="pingzhengEditor.openPingZhengChongXiangEditer(tableSelectedRowObjs)">&nbsp;冲销&emsp;&emsp;</span><br/>
              <span class="group-btn-span-special"
                    @click="pingzhengEditor.openPingZhengCopyEditer(tableSelectedRowObjs)">&nbsp;复制&emsp;&emsp;</span><br/>
      ...
      <div class="app-container-top-two">
        <div class="act-two-d-left">
          <AccountPicker v-if="showThis" readonly="" theme="one" @reloadTable="pageReload2"/>
        </div>
...
import Print from "/@/views/boozsoft/global/popup/accvoucher/print.vue";
import Review from "/@/views/boozsoft/global/popup/accvoucher-review/review.vue";
import Cashier from "/@/views/boozsoft/global/popup/accvoucher-cashier/cashier.vue";
import Query from "/@/views/boozsoft/global/popup/accvoucher/query.vue";
import CustomizeReplace from "/@/views/boozsoft/global/popup/accvoucher/CustomizeReplace.vue";
import Sign from "/@/views/boozsoft/global/popup/accvoucher-super-sign/sign.vue";
import Book from "/@/views/boozsoft/global/popup/accvoucher-book/book.vue";
...
// } from "/@/views/boozsoft/global/popup/accvoucher-super-sign/bus";
// import {
//   checkMeetSpecifyConditions as checkMeetSpecifyConditionsBook
// } from "/@/views/boozsoft/global/popup/accvoucher-book/bus";
// import {
//   checkMeetSpecifyConditions as checkMeetSpecifyConditionsCashier
// } from "/@/views/boozsoft/global/popup/accvoucher-cashier/bus";
...
import VoucherTree from "/@/views/boozsoft/gdzc/fa-accvoucher/Component/VoucherTree.vue";
...
<style src="../../../../assets/styles/pingzheng-menu-index.less" lang="less" scoped="scoped"></style>
