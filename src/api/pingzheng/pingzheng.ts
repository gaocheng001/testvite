...
export const delPingZhengByUniqueCodeApi = defRouteApi(async (params) => {
  return {
    url: Api.delPingZhengByUniqueCodeApi,
    method: 'POST',
    params,
  };
});
...
export async function savePingZhengApi(apiData) {
  return await savePingZheng({ json: JSON.stringify(apiData) }, null);
}

export const insertPingZheng = defRouteApi(async (params) => {
  return {
    url: Api.insertPingZheng,
    method: 'POST',
    params,
  };
});
...
export const findTempData = defRouteApi(async (params) => {
  return {
    url: '/pingzheng/findTempData',
    method: 'POST',
    params,
  };
});
