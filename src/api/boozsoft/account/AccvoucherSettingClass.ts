...
enum Api {
  findAll = `/AccvoucherSettingClass/findAll`,
  findById = `/AccvoucherSettingClass/findById`,
  save = `/AccvoucherSettingClass/save`,
  deleteById = `/AccvoucherSettingClass/deleteById`
}
...
export const findMaxClassCode = defRouteApi(() => {
  return {
    url: '/AccvoucherSettingClass/findMaxClassCode',
    method: 'GET'
  }
})
...
export const findBukongClassCode = defRouteApi(() => {
  return {
    url: '/AccvoucherSettingClass/findBukongClassCode',
    method: 'GET'
  }
})
